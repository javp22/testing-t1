...
Se generaron 20 suites, con 174 tests y 387 verificaciones explícitas. Según `metrics_average.json`, el promedio global fue 90.55% de cobertura de líneas, 80.9% de ramas y 71.7% de mutation score. En 19/20 objetivos las métricas fueron no nulas y 15/20 alcanzaron simultáneamente al menos 50% en las tres métricas. Solo un objetivo quedó completamente en cero, siendo el archivo de `svm`; además, existen casos con cobertura alta pero mutation score bajo, demostrando que cubrir líneas no garantiza calidad semántica.
